...
object OpenAppDetailsAction : CapabilityDefinition {
    override val type = "android.app.details"
    override val lane = CapabilityLane.ACTION
    override val displayName = "Open app details"
    override val description =
        "Opens Android's app details settings page for one exact package."
    override val creation = CapabilityCreation(
        idBase = "open-app-details",
    ...
    override fun explain(block: MacroBlock): String =
        "Open Android app details for package ${
