...
import com.vibhor1102.zerobit.openmacro.capability.builtin.VibrationAvailabilityCondition
...
import com.vibhor1102.zerobit.openmacro.capability.builtin.BatteryTemperatureCondition
...
import com.vibhor1102.zerobit.openmacro.capability.builtin.DeviceIdleModeTrigger
    ...
    companion object {
        fun builtIn(): CapabilityRegistry = CapabilityRegistry(
            definitions = listOf(
                ...
                BatteryPresenceTrigger,
                DockStateTrigger,
                DeviceIdleModeTrigger,
