...
sealed interface RuntimeStep {
    ...
    data class ObserveBatteryHealth(
        override val blockId: String,
    ...
    data class ObserveBatteryStatus(
        override val blockId: String,
        val expectedStatus: BatteryStatus,
    ) : RuntimeStep

    data class ObserveBatteryPresence(
        override val blockId: String,
    ...
    data class CheckMicrophoneAvailability(
        override val blockId: String,
        val expectedAvailable: Boolean,
    ) : RuntimeStep
